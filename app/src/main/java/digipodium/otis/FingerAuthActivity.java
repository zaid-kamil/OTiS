...
public class FingerAuthActivity extends AppCompatActivity {
    ...
    private static final String TAG = FingerAuthActivity.class.getSimpleName();
    ...
    public void onVerified(boolean withFingerprint, @Nullable FingerprintManager.CryptoObject cryptoObject) {
        if (withFingerprint) {
    ...
    private class PurchaseButtonClickListener implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            if (initCipher(mCipher, mKeyName)) {
                ...
                LoginAuthenticationDialogFragment fragment
                        = new LoginAuthenticationDialogFragment();
                ...
                if (useFingerprintPreference) {
                    fragment.setStage(
                            LoginAuthenticationDialogFragment.Stage.FINGERPRINT);
                } else {
                    fragment.setStage(
                            LoginAuthenticationDialogFragment.Stage.PASSWORD);
                }
                ...
                fragment.setCryptoObject(new FingerprintManager.CryptoObject(mCipher));
                fragment.setStage(
                        LoginAuthenticationDialogFragment.Stage.NEW_FINGERPRINT_ENROLLED);
                fragment.show(getFragmentManager(), DIALOG_FRAGMENT_TAG);
            }
        }
    }
